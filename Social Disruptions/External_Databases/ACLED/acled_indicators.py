...
def country_month_panel(
    ...
    *,
    ...
    """Aggregate ACLED events to a country-month panel. severity controls how severity_score is built:
    count_plus_fatalities (default), fatalities_only, or count_only."""
    if events.empty:
