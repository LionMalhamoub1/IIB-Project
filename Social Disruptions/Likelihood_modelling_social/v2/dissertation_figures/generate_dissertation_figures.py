...
=================================
Generates dissertation-quality figures explaining the GDELT event clustering
pipeline.  Reads from the grouped/ output directory (2018 data).

Figures produced
----------------
1. fig1_pipeline_architecture.pdf  -- Flowchart of the full pipeline
2. fig2_similarity_weights.pdf     -- Weighted similarity breakdown (pie)
3. fig3_cluster_size_dist.pdf      -- Distribution of n_articles per cluster
4. fig4_cohesion_dist.pdf          -- Distribution of mean_internal_score
5. fig5_reduction_by_type.pdf      -- Raw vs canonical events by type
6. fig6_events_per_country.pdf     -- Top-25 countries by event count
7. fig7_temporal_windows.pdf       -- Dynamic temporal gate by event type

Run from the repository root or directly:
    python "Social Disruptions/verification/generate_dissertation_figures.py"
"""
