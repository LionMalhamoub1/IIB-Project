"""
generate_same_country_separation.py
=====================================
Illustrates that articles from the same country on the same day are correctly
separated into different clusters when they describe different events.

Real example: India, 1 January 2018
  - Event 1: Doctors / NMC Bill protest (Rajasthan & Kerala)
  - Event 2: Kashmir paramilitary clash  (Muzaffarnagar / J&K)
  - Event 3: Tribal rights protest       (Visakhapatnam)

Key message: within-cluster similarity >> across-cluster similarity,
so Level-1 clustering produces three separate connected components.
"""
