"""
export_m2.py
Generates all M2 (Full Macro) figures and saves them to final figures/M2/.

M2 = M0 + M1 (markets) + M2_ADD (macro, labour, governance)

Outputs:
  m2_static_timelines_{protest,strike}_7d.png
  m2_expanding_timelines_{protest,strike}_7d.png
  m2_expanding_performance_{protest,strike}_7d.png
  m2_coefficients_{protest,strike}_7d.png
  m2_metrics.csv
"""
