"""
Patch: add model9_twostage to expanding-LR outputs.

Each month:
  Stage 1 — LR on slow features (M2+M3+M4), 5-fold stratified CV on training
             data for out-of-fold risk scores; refit on full training data
             for test predictions.
  Stage 2 — LR on fast features (M0+M1) + structural_risk_score, with country FE.
"""
