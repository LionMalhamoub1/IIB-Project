"""
train_expanding_xgb.py
Quarterly expanding window evaluation for XGBoost models.

Uses fixed hyperparameters (XGB_PARAM_GRID[0]) to avoid slow Optuna per quarter.
8 quarters: 2020-Q1 through 2021-Q4.

Outputs saved to data/processed/expanding_xgb/:
  preds_{target}.parquet
  metrics_{target}.csv
"""
