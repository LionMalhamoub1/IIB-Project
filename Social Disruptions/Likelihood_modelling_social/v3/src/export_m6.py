"""
export_m6.py
Generates all M6 (XGBoost Full) figures and saves them to final figures/M6/.

M6 = model5_xgb — XGBoost on full feature set (M0+M1+M2+M3+M4, no country baselines)

Outputs:
  m6_static_timelines_{protest,strike}_7d.png
  m6_expanding_timelines_{protest,strike}_7d.png
  m6_expanding_performance_{protest,strike}_7d.png
  m6_shap_{protest,strike}_7d.png
  m6_metrics.csv
"""
