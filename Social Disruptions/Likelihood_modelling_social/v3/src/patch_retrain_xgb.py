"""
Patch: retrain model5_xgb and model6_xgb_nolag after removing country baselines.
Only runs protest_7d and strike_7d.

Replaces rows in:
  data/processed/{target}/preds.parquet
  data/processed/{target}/metrics.csv
  data/processed/{target}/shap_importance.csv
  data/processed/{target}/feature_importance_summary.csv
"""
