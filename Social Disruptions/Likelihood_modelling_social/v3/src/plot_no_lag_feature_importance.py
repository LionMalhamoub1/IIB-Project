"""
plot_no_lag_feature_importance.py
==================================
Produces four publication-quality figures for the results chapter:

  Figure 1 — M5 (model_lr_nolag) logistic regression indicator importance
    Input : v3/data/processed/{protest_7d,strike_7d}/coefs_lr.csv
    Method: average standardised coefficients across fold_id 1 and 2,
            exclude country FE terms (fe__ prefix), take top 10 by |coef|
    Output: v3/figures/m5_logistic_no_lag_feature_importance.{png,pdf}

  Figure 2 — M7 (model6_xgb_nolag) SHAP indicator importance
    Input : v3/data/processed/{protest_7d,strike_7d}/shap_importance.csv
            (already averaged across folds in train_backtest.py)
    Method: filter model6_xgb_nolag, exclude country FE terms, top 10 by
            mean_abs_shap; bars coloured by sign of mean_shap
    Output: v3/figures/m7_xgboost_no_lag_shap_importance.{png,pdf}

  Figure 3 — M3 (model3_structural) logistic regression indicator importance
    Input : v3/data/processed/{protest_7d,strike_7d}/coefs_lr.csv
    Method: same as M5 but includes GDELT lag features; exclude country FE
    Output: v3/figures/m3_logistic_structural_feature_importance.{png,pdf}

  Figure 4 — M6 (model5_xgb) XGBoost SHAP indicator importance
    Input : v3/data/processed/{protest_7d,strike_7d}/shap_importance.csv
    Method: filter model5_xgb, exclude country FE, top 10 by mean_abs_shap
    Output: v3/figures/m6_xgboost_full_shap_importance.{png,pdf}
"""
