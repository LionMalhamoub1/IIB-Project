"""
analyse_comparison.py
=====================
Reads all comparison CSVs produced by compare_gdelt_acled.py and produces
a written analysis report plus summary figures.

Outputs
-------
  verification/comparison/analysis_report.txt   — plain-text findings
  verification/comparison/fig1_match_breakdown.png
  verification/comparison/fig2_distance_histogram.png
  verification/comparison/fig3_match_by_type.png
  verification/comparison/fig4_no_match_countries.png
  verification/comparison/fig5_acled_only_regions.png
  verification/comparison/fig6_daily_summary.png

Usage
-----
  python analyse_comparison.py
"""
