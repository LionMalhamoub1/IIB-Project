# Deduplicates GDELT protest/strike records into one canonical event per incident.
# Similarity graph over articles; connected components = same real-world event.
# Score is renormalised over available features so sparse records aren't penalised.
