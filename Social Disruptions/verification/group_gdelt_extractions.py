# Two-level clustering of GDELT extractions into canonical events (L1) and movements (L2).
# L1: similarity graph over articles within a day. L2: links clusters across days via centroids.
# Confidence-weighted edges — low-quality articles need a stronger match to cluster.
