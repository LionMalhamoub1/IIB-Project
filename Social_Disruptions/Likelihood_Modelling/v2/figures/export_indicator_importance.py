# Generates indicator importance figures and saves to final_figures/indicator_importance_outputs/.
import matplotlib
matplotlib.use("Agg")
...
OUT_DIR = Path(__file__).resolve().parent.parent / "final_figures" / "indicator_importance_outputs"
